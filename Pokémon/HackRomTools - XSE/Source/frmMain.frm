...
Dim sIniPath As String
    ...
    mnuAutomaticallyCheck.Checked = CBool(ReadIniString(sIniPath, "Options", "AutoUpdateCheck", 1))
...
Dim sIniPath As String
    ...
    WriteStringToIni sIniPath, "Options", "AutoUpdateCheck", -CInt(mnuAutomaticallyCheck.Checked)
